...
public class ucs {
    ...
    public static void solve(String start) {
        ...
        queue.add(new Node(start, 0, "Start", 0, null));
        visited.add(start);
            ...
            for (int d = 0; d < DIRECTIONS.length; d++) {
                ...
                if (newX >= 0 && newX < 3 && newY >= 0 && newY < 3) {
                    ...
                    if (!visited.contains(swapped)) {
                        ...
                        queue.add(new Node(swapped, current.cost + tileValue, "Move " + tileValue + " " + MOVES[d], current.depth + 1, current));
                        nodesExpanded++;
                        visited.add(swapped);
